...
exports.updateData = function(localDomain, hash, json, isProtected, callback) {
    Domain.findOne({localDomain: localDomain}, "_id", function(err, currentSite) {
        if (currentSite) {
            ...
            Data.update({hash: hash}, {$set: newData}, function (err, numberAffected) {
    ...
    Domain.findOne({localDomain: localDomain}, "_id", function(err, currentSite) {
        if (currentSite) {
            ...
            Data.findOne({domainId: currentSite._id, hash: hash}, function(err, results) {
                if (results) {
                    exports.updateData(localDomain, hash, json, isProtected, callback);
                } else {
